...
main_frame = tk.Frame(monopoly_window,
                      width=board_side - 2,
                      height=board_side - 2,
                      background='white')
...
board_image = ImageTk.PhotoImage(
    ImageOps.expand(
        Image.open("Assets/BoardIMG.jpg").resize((board_side, board_side),
                                                 Image.ANTIALIAS)))

ttk.Label(board_frame, image=board_image).place(relx=0.499,
                                                rely=0.499,
                                                anchor='center')
...
tk.Button(board_frame,
          ...
          command=lambda: property_frame_popup("Old Kent Road")).place(
              x=posvar - 1.6 * property_width, y=posvar, anchor='center')

tk.Button(board_frame,
          image=small_info_tag,
          border=0,
          highlightthickness=0,
          command=lambda: property_frame_popup("Whitechapel Road")).place(
              x=posvar - 3.6 * property_width, y=posvar, anchor='center')

tk.Button(board_frame,
          image=small_info_tag,
          border=0,
          highlightthickness=0,
          command=lambda: property_frame_popup("Kings Cross Station")).place(
              x=posvar - 5.6 * property_width, y=posvar, anchor='center')

tk.Button(board_frame,
          image=small_info_tag,
          border=0,
          highlightthickness=0,
          command=lambda: property_frame_popup("The Angel, Islington")).place(
              x=posvar - 6.6 * property_width, y=posvar, anchor='center')

tk.Button(board_frame,
          image=small_info_tag,
          border=0,
          highlightthickness=0,
          command=lambda: property_frame_popup("Euston Road")).place(
              x=posvar - 8.6 * property_width, y=posvar, anchor='center')

tk.Button(board_frame,
          image=small_info_tag,
          border=0,
          highlightthickness=0,
          command=lambda: property_frame_popup("Pentonville Road")).place(
              x=posvar - 9.6 * property_width, y=posvar, anchor='center')
...
tk.Button(board_frame,
          ...
          border=0,
          highlightthickness=0,
          command=lambda: property_frame_popup("Pall Mall")).place(
              x=posvar - 11.825 * property_width,
              y=posvar - 1.6 * property_width,
              anchor='center')
...
tk.Button(board_frame,
          ...
          border=0,
          highlightthickness=0,
          command=lambda: property_frame_popup("Electric Company")).place(
              x=posvar - 11.825 * property_width,
              y=posvar - 2.6 * property_width,
              anchor='center')
...
tk.Button(board_frame,
          ...
          border=0,
          highlightthickness=0,
          command=lambda: property_frame_popup("Whitehall")).place(
              x=posvar - 11.825 * property_width,
              y=posvar - 3.6 * property_width,
              anchor='center')
...
tk.Button(board_frame,
          ...
          border=0,
          highlightthickness=0,
          command=lambda: property_frame_popup("Northumbl'd Avenue")).place(
              x=posvar - 11.825 * property_width,
              y=posvar - 4.6 * property_width,
              anchor='center')
...
tk.Button(board_frame,
          ...
          border=0,
          highlightthickness=0,
          command=lambda: property_frame_popup("Marylebone Station")).place(
              x=posvar - 11.825 * property_width,
              y=posvar - 5.6 * property_width,
              anchor='center')
...
tk.Button(board_frame,
          ...
          border=0,
          highlightthickness=0,
          command=lambda: property_frame_popup("Bow Street")).place(
              x=posvar - 11.825 * property_width,
              y=posvar - 6.6 * property_width,
              anchor='center')
...
tk.Button(board_frame,
          ...
          border=0,
          highlightthickness=0,
          command=lambda: property_frame_popup("Marlborough Street")).place(
              x=posvar - 11.825 * property_width,
              y=posvar - 8.6 * property_width,
              anchor='center')
...
tk.Button(board_frame,
          ...
          border=0,
          highlightthickness=0,
          command=lambda: property_frame_popup("Vine Street")).place(
              x=posvar - 11.825 * property_width,
              y=posvar - 9.6 * property_width,
              anchor='center')
...
tk.Button(board_frame,
          ...
          border=0,
          highlightthickness=0,
          command=lambda: property_frame_popup("Strand")).place(
...
tk.Button(board_frame,
          ...
          border=0,
          highlightthickness=0,
          command=lambda: property_frame_popup("Fleet Street")).place(
...
tk.Button(board_frame,
          ...
          border=0,
          highlightthickness=0,
          command=lambda: property_frame_popup("Trafalgar Square")).place(
...
tk.Button(board_frame,
          ...
          border=0,
          highlightthickness=0,
          command=lambda: property_frame_popup("Fenchurch St. Station")).place(
...
tk.Button(board_frame,
          ...
          border=0,
          highlightthickness=0,
          command=lambda: property_frame_popup("Leicester Square")).place(
...
tk.Button(board_frame,
          ...
          border=0,
          highlightthickness=0,
          command=lambda: property_frame_popup("Coventry Street")).place(
...
tk.Button(board_frame,
          ...
          border=0,
          highlightthickness=0,
          command=lambda: property_frame_popup("Water Works")).place(
...
tk.Button(board_frame,
          ...
          border=0,
          highlightthickness=0,
          command=lambda: property_frame_popup("Piccadilly")).place(
...
tk.Button(board_frame,
          ...
          border=0,
          highlightthickness=0,
          command=lambda: property_frame_popup("Regent Street")).place(
              x=posvar, y=posvar - 10.2 * property_width, anchor='center')

tk.Button(board_frame,
          image=small_info_tag,
          border=0,
          highlightthickness=0,
          command=lambda: property_frame_popup("Oxford Street")).place(
              x=posvar, y=posvar - 9.2 * property_width, anchor='center')

tk.Button(board_frame,
          image=small_info_tag,
          border=0,
          highlightthickness=0,
          command=lambda: property_frame_popup("Bond Street")).place(
              x=posvar, y=posvar - 7.2 * property_width, anchor='center')

tk.Button(board_frame,
          image=small_info_tag,
          border=0,
          highlightthickness=0,
          command=lambda: property_frame_popup("Liverpool St. Station")).place(
              x=posvar, y=posvar - 6.2 * property_width, anchor='center')

tk.Button(board_frame,
          image=small_info_tag,
          border=0,
          highlightthickness=0,
          command=lambda: property_frame_popup("Park Lane")).place(
              x=posvar, y=posvar - 4.2 * property_width, anchor='center')

tk.Button(board_frame,
          image=small_info_tag,
          border=0,
          highlightthickness=0,
          command=lambda: property_frame_popup("Mayfair")).place(
              x=posvar, y=posvar - 2.2 * property_width, anchor='center')
# endregion
...
red_token = tk.Button(board_frame,
                      image=red_token_image,
                      border=0,
                      highlightthickness=0,
                      command=lambda: player_frame_popup("Player 1"))
red_token.place(x=board_side - 1.2 * property_width,
                y=board_side - 0.75 * property_width,
                anchor='center')

green_token = tk.Button(board_frame,
...
blue_token = tk.Button(board_frame,
...
yellow_token = tk.Button(board_frame,
...
roll_button = ttk.Button(board_frame,
                         text="Roll Dice",
                         style="my.TButton",
                         command=lambda: roll_dice())
...
d["Mayfair"] = dict(
    zip([
        "Rent", 'With Color Set', 'With 1 House', 'With 2 Houses',
        'With 3 Houses', 'With 4 Houses', 'With Hotel', 'Mortgage Value',
...
def property_frame_popup(property):
    ...
    property_frame = tk.Frame(main_frame,
    ...
    if 'station' in property.lower():
        station_label = tk.Label(property_frame,
                                 image=station_image,
                                 border=0,
                                 highlightthickness=0)
        ...
        tk.Label(property_frame,
                 ...
                 bg='#F9FBFF').place(relx=0.5, rely=0.4, anchor='center')

        tk.Button(property_frame,
                  text='✕',
                  ...
                  command=delete_property_frame).place(relx=0.95,
                                                       rely=0.05,
                                                       anchor='ne')

        canvas = tk.Canvas(property_frame,
                           highlightthickness=0,
        ...
        ttk.Separator(canvas, orient='horizontal').place(relx=0.5,
                                                         rely=0.8,
                                                         anchor="center",
                                                         relwidth=0.8)
        ...
        tk.Label(property_frame,
                 ...
                 fg=player_color,
                 bg='#F9FBFF').place(relx=0.5, rely=0.475, anchor='center')

        tk.Button(property_frame,
                  image=big_info_tag,
                  border=0,
                  highlightthickness=0,
                  command=station_rules).place(x=35, rely=0.9, anchor='center')
        ...
        for i, j in stations_data.items(
        ):  # Placing and formatting Rent data on card
            row_counter += 1
            if row_counter == owner_stations_owned:
                canvas.create_text(2,
                                   y_coord - 2,
                                   anchor='w',
                                   text="▶",
            ...
            if row_counter == 5:  # mortgage
                ...
                canvas.create_text(canvas.winfo_width() / 1.3,
                                   y_coord,
                                   text="₩",
                                   angle=180,
                                   font=("courier", (board_side - 2) // 51))
                canvas.create_text(canvas.winfo_width() - 35,
                                   y_coord,
                                   anchor='e',
                                   text=str(j),
                                   font=("times", (board_side - 2) // 51))
                ...
                canvas.create_text(canvas.winfo_width() - 25,
                                   y_coord,
                                   anchor='e',
                                   text=str(j),
                                   font=("times", (board_side - 2) // 45))
        ...
        utility_label = tk.Label(property_frame,
                                 image=utility_image,
                                 border=0,
                                 highlightthickness=0)
        ...
        tk.Button(property_frame,
                  ...
                  border=0,
                  highlightthickness=0,
                  command=utility_rules).place(x=35,
                                               rely=0.925,
                                               anchor='center')
        ...
        for i, j in utilities_data.items(
        ):  # Placing and formatting Rent data on card
            row_counter += 1
            ...
            if row_counter in [1, 2, 4]:  #text row
                ...
                canvas.create_text(canvas.winfo_width() / 2.75,
                                   y_coord,
                                   anchor='w',
                                   text=i,
                                   font=("times", (board_side - 2) // 45))
        ...
        title_frame = tk.Frame(property_frame,
                               width=(board_side - 2) // 2.25,
        ...
        tk.Label(title_frame,
                 text=property.upper(),
                 font=("times", (board_side - 2) // 40),
                 bg=property_color).place(relx=0.5, rely=0.65, anchor='center')
        ...
        tk.Button(title_frame,
                  ...
                  command=delete_property_frame).place(relx=1,
                                                       rely=0,
                                                       anchor='ne')
        ...
        tk.Label(property_frame,
                 ...
                 font=("times", (board_side - 2) // 46),
                 fg=player_color,
                 bg='#F9FBFF').place(relx=0.5, rely=0.25, anchor='center')
        ...
        for i, j in d[property].items(
            ...
            if row_counter in [-1, 0]:  # rent, double rent
                ...
                canvas.create_text(canvas.winfo_width() / 1.375,
                                   y_coord,
                                   text="₩",
                                   angle=180,

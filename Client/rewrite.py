...
from tkinter import E, messagebox as msgb
...
class arcade(tk.Toplevel):
    ...
    def join_lobby(self, game, updating=False):
        """Updates rooms in lobby
        game - indicated which lobby
        updating - indicates whether to update"""
        ...
        tk.Button(
            ...
            border=0,
            command=lambda: self.leave_lobby(game),  # Leave Lobby Button
        ...
        self.lobby_tree.column("#0", width=10)
        ...
        tk.Button(
            ...
            text="Join",
            font=("times", 13),
            command=lambda: self.join_selected_room(  # Joining button
